 ...
 *    a jumber from pin 9 to pin 11 or pin 10 to pin 11. Then uncomment one of
 * the two #defines below to activate the PWM on either pin 9 or pin 10. You
 * will then have a fully functional microstepping for 2 stepper motors, or four
...
public:
    ...
    void
         step(uint16_t steps, uint8_t dir, uint8_t style = SINGLE);
